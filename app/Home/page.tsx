        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 px-6">
          <div className="space-y-8">
            ...
            <p className="text-lg leading-relaxed opacity-90">
              {language === "EN"
                ? "Hi, my name is Franco Ferrer, I'm a frontend developer based in Puebla, México."
                : "Hola, mi nombre es Franco Ferrer, soy desarrollador frontend en Puebla, México."}
            </p>
        ...
        <div className={cardStyles.container}>
            ...
            <div className={cardStyles.content}>
              <p>
                {language === "EN"
                  ...
                  : "Mis redes y sitios de contacto"}
              </p>
              <div className={cardStyles.icons}>
                <a href="https://github.com/jeanfranco22">
                  <FaGithub />
                </a>
                <a href="">
                  <FaLinkedin />
          ...
          >
            ...
            <div className={cardStyles.content}>
              <p>
                {language === "EN"
                  ? "Video game developed using Vanilla JS, CSS, and HTML."
                  : "Videojuego desarrollado con Vanilla JS, CSS, HTML"}
              </p>
            </div>
          </Link>
          ...
          >
            ...
            <div className={cardStyles.content}>
              <p>
                {language === "EN"
                  ? "Jewelry e-commerce inspired by Cartier."
                  : "Tienda de joyería inspirada en Cartier"}
              </p>
            </div>
          </Link>
          ...
          >
            ...
            <div className={cardStyles.content}>
              <p>
                {language === "EN"
                  ? "Pilates website for booking appointments"
                  : "Sitio de pilates para agendar citas"}
              </p>
            </div>
          </Link>
        </div>
